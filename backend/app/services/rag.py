...
_KEYWORD_SECTIONS: dict[str, list[str]] = {
    ...
    "exit_strategy": ["Stop Loss Framework", "Rolling and Adjustments", "Risk Management Rules"],
    "realized_vol": ["Realized (Historical) Volatility", "Volatility Clusters", "IV vs. HV Gap"],
    "higher_order_greeks": ["Higher-Order Greeks", "Core Greeks", "Greeks Quick Reference"],
    "regime_awareness": ["Regime Categories", "Regime Detection Signals", "Market Regime Analysis", "Structure Selection Matrix"],
    "event_driven": ["Event-Driven Volatility", "Earnings Trade Framework", "Expected Move", "Pre-Earnings", "Post-Earnings"],
    "gamma_mechanics": ["Gamma Exposure", "Gamma Squeeze", "0DTE Volume", "Pinning Risk"],
