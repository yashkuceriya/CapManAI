...
export default function MTSSError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[CapMan] MTSS page error:', error)
  }, [error])

  return (
    <div className="max-w-6xl mx-auto py-20 text-center">
      <div className="card border-red-500/20 bg-red-500/[0.03] p-10">
        <h2 className="text-xl font-bold text-white mb-2">MTSS Dashboard Error</h2>
        <p className="text-gray-400 text-sm mb-6">
          Could not load the MTSS dashboard. Please try again.
        </p>
        {error.digest && (
