...
export default function PeerReviewError({
  ...
  useEffect(() => {
    console.error('[CapMan] Peer Review page error:', error)
  }, [error])

  return (
    <div className="max-w-4xl mx-auto py-20 text-center">
      <div className="card border-red-500/20 bg-red-500/[0.03] p-10">
        <h2 className="text-xl font-bold text-white mb-2">Peer Review Error</h2>
        <p className="text-gray-400 text-sm mb-6">
          Something went wrong loading peer reviews. Please try again.
        </p>
        {error.digest && (
